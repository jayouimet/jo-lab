...
export default function Piece({piece, width = 45, height = 45, onClick, ...props}) {
    const getPiece = (piece) => {
        if (piece == 'wR') {
            return (
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width={width} height={height} viewBox="0 0 45 45">
                    <g
                        style={{
                            opacity: '1',
                            fill: '#ffffff',
        ...
        if (piece == 'x') {
            return (
                <div className={styles.xStyle} style={{width: width, height: (height / 1.5)}}>
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" width={width / 3} height={height / 3}
                        viewBox="0 0 460.775 460.775" style={{enableBackground: "new 0 0 460.775 460.775", fill: '#000',}}>
